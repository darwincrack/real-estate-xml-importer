    ...
    <div class="wrap reip-admin">
        ...
        <form method="post" id="reip-import-form">
            ...
            <div class="form-field" style="margin-bottom: 20px;">
                ...
                <label for="xml_type_2">https://xml.tmgrupoinmobiliario.com/xmlKyero.php</label><br>

                <input type="radio" id="url_type_partial" name="xml_type" value="3">

                <label for="xml_type_3">https://xml.redsp.net/file/506/23x465s0951/general-zone-1-kyero.xml  (Propiedades de nueva Construcción <a href="https://jonathansuarezr.com/categoria-propiedad/propiedades-de-nueva-construccion/" target="_blank">Ver</a> )</label> <br>

                <input type="radio" id="url_type_partial" name="xml_type" value="4">

                <label for="xml_type_4">https://app.vendomia.es/feed/xml/all/125/edb8840caae1b65487d74f8e9729aaca (Oportunidades Inmobiliarias <a href="https://jonathansuarezr.com/categoria-propiedad/oportunidades-inmobiliarias/" target="_blank">Ver</a> )</label> 
